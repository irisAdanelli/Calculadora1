package mx.edu.ittepic.calculadora1;
...
public class CalculaDora extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calcula_dora);
        ...
        igual.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (oper==1){
                    ...
                    if(s2==0){
                        Toast.makeText(CalculaDora.this,"NO SE DIVIDE ENTRE 0", Toast.LENGTH_LONG).show();
                    }
    ...
    /*public Float sumarDatos(Float s2){
        try {
            sumado += s2;
            num.setText("");
            ...
            Toast.makeText(this, "error de sumar", Toast.LENGTH_SHORT).show();
        }

        return sumado;
    }
    public void restarDatos(String n1r, String n2r){
        String resultadoResta;
        resultadoResta=n1r+n2r;

    }
    public void multiplicarDatos(String n1m,String n2m){
        String resultadoMulti;
        resultadoMulti=n1m+n2m;

    }
    public void dividirDatos(String n1d, String n2d){
        String resultadoDiv;
        resultadoDiv=n1d+n2d;

    }

    public void calcularResultado(Float c){
        try {
            float result = c;
            if (sumado != 0) {
                calculado = sumado + result;
                r = String.valueOf(calculado);
                num.setText(r);
            }
            if (restado != 0) {
            ...
            Toast.makeText(this, "Error de calcular", Toast.LENGTH_SHORT).show();
        }
    }*/
